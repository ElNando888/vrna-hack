...
const char *RNAeval_args_info_detailed_help[] = {
  ...
  "      --ligand=STRING        Adds a ligand in the solution\n",
...
init_full_help_array(void)
{
  ...
  RNAeval_args_info_full_help[9] = RNAeval_args_info_detailed_help[9];
  RNAeval_args_info_full_help[10] = RNAeval_args_info_detailed_help[10];
  RNAeval_args_info_full_help[11] = RNAeval_args_info_detailed_help[11];
  RNAeval_args_info_full_help[12] = RNAeval_args_info_detailed_help[13];
  RNAeval_args_info_full_help[13] = RNAeval_args_info_detailed_help[14];
  RNAeval_args_info_full_help[14] = RNAeval_args_info_detailed_help[16];
  RNAeval_args_info_full_help[15] = RNAeval_args_info_detailed_help[17];
  RNAeval_args_info_full_help[16] = RNAeval_args_info_detailed_help[18];
  RNAeval_args_info_full_help[17] = RNAeval_args_info_detailed_help[20];
  RNAeval_args_info_full_help[18] = RNAeval_args_info_detailed_help[21];
  RNAeval_args_info_full_help[19] = 0; 
  
}

const char *RNAeval_args_info_full_help[20];
...
init_help_array(void)
{
  ...
  RNAeval_args_info_help[11] = RNAeval_args_info_detailed_help[11];
  RNAeval_args_info_help[12] = RNAeval_args_info_detailed_help[13];
  RNAeval_args_info_help[13] = RNAeval_args_info_detailed_help[14];
  RNAeval_args_info_help[14] = RNAeval_args_info_detailed_help[16];
  RNAeval_args_info_help[15] = RNAeval_args_info_detailed_help[17];
  RNAeval_args_info_help[16] = RNAeval_args_info_detailed_help[18];
  RNAeval_args_info_help[17] = RNAeval_args_info_detailed_help[21];
  RNAeval_args_info_help[18] = 0; 
  
}

const char *RNAeval_args_info_help[19];
...
void clear_args (struct RNAeval_args_info *args_info)
{
  ...
  args_info->ligand_arg = NULL;
  args_info->ligand_orig = NULL;
...
void init_args_info(struct RNAeval_args_info *args_info)
{
  ...
  args_info->temp_help = RNAeval_args_info_detailed_help[9] ;
  args_info->noTetra_help = RNAeval_args_info_detailed_help[10] ;
  args_info->dangles_help = RNAeval_args_info_detailed_help[11] ;
  args_info->energyModel_help = RNAeval_args_info_detailed_help[13] ;
  args_info->paramFile_help = RNAeval_args_info_detailed_help[14] ;
  args_info->circ_help = RNAeval_args_info_detailed_help[16] ;
  args_info->gquad_help = RNAeval_args_info_detailed_help[17] ;
  args_info->logML_help = RNAeval_args_info_detailed_help[18] ;
  args_info->ligand_help = RNAeval_args_info_detailed_help[20] ;
  args_info->ligand_min = 0;
  args_info->ligand_max = 0;
...
RNAeval_cmdline_parser_release (struct RNAeval_args_info *args_info)
{
  ...
  free_multiple_string_field (args_info->ligand_given, &(args_info->ligand_arg), &(args_info->ligand_orig));
...
RNAeval_cmdline_parser_dump(FILE *outfile, struct RNAeval_args_info *args_info)
{
  ...
  write_multiple_into_file(outfile, args_info->ligand_given, "ligand", args_info->ligand_orig, 0);
...
RNAeval_cmdline_parser_required2 (struct RNAeval_args_info *args_info, const char *prog_name, const char *additional_error)
{
  ...
  if (check_multiple_option_occurrences(prog_name, args_info->ligand_given, args_info->ligand_min, args_info->ligand_max, "'--ligand'"))
     error_occurred = 1;
                        ...
                        struct RNAeval_cmdline_parser_params *params, const char *additional_error)
{
  ...
  struct generic_list * ligand_list = NULL;
  int error_occurred = 0;
...
.  */
          else if (strcmp (long_options[option_index].name, "ligand") == 0)
          {
          
            if (update_multiple_arg_temp(&ligand_list, 
                &(local_args_info.ligand_given), optarg, 0, 0, ARG_STRING,
                "ligand", '-',
                additional_error))
              goto failure;
  ...
  update_multiple_arg((void *)&(args_info->ligand_arg),
    &(args_info->ligand_orig), args_info->ligand_given,
    local_args_info.ligand_given, 0,
    ARG_STRING, ligand_list);

  args_info->ligand_given += local_args_info.ligand_given;
  local_args_info.ligand_given = 0;
