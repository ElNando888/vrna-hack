...
.  */
 ...
 help description.  */
  char ** ligand_arg;	/**< @brief Adds a ligand in the solution
.  */
  char ** ligand_orig;	/**< @brief Adds a ligand in the solution
 original value given at command line.  */
  unsigned int ligand_min; /**< @brief Adds a ligand in the solution
's minimum occurreces */
  unsigned int ligand_max; /**< @brief Adds a ligand in the solution
's maximum occurreces */
  const char *ligand_help; /**< @brief Adds a ligand in the solution
 help description.  */
  ...
  unsigned int ligand_given ;	/**< @brief Whether ligand was given.  */
