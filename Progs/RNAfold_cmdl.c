...
init_full_help_array(void)
{
  ...
  RNAfold_args_info_full_help[32] = RNAfold_args_info_detailed_help[43];
  RNAfold_args_info_full_help[33] = 0; 
  
}

const char *RNAfold_args_info_full_help[34];
...
init_help_array(void)
{
  ...
  RNAfold_args_info_help[24] = RNAfold_args_info_detailed_help[43];
...
void init_args_info(struct RNAfold_args_info *args_info)
{
  ...
  args_info->ligand_help = RNAfold_args_info_detailed_help[42] ;
