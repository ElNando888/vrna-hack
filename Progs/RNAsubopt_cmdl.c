...
init_full_help_array(void)
{
  ...
  RNAsubopt_args_info_full_help[32] = RNAsubopt_args_info_detailed_help[43];
  RNAsubopt_args_info_full_help[33] = 0; 
  
}

const char *RNAsubopt_args_info_full_help[34];
...
init_help_array(void)
{
  ...
  RNAsubopt_args_info_help[28] = RNAsubopt_args_info_detailed_help[43];
...
void init_args_info(struct RNAsubopt_args_info *args_info)
{
  ...
  args_info->ligand_help = RNAsubopt_args_info_detailed_help[42] ;
